...
<body>
    ...
    <section class="container col-md-5 my-5 ">
        <h1 class="text-strat  fw-bold my-4">List Courses
            <a href="./create.php" class="btn btn-dark float-end"> Add Courses</a>
        </h1>
            ...
            <table class="table table-dark table-striped">
                ...
                <?php foreach ($All as $course) : ?>
                    <tr>
                        <td> <?= $id++; ?> </td>
                        <td> <?= $course['title'] ?></td>
                        <td><a href="./show.php?id=<?= base64_encode($course['id']) ?>"><i class="fa-solid fa-eye"></i></a></td>
                        <td><a href="./eidt.php?id=<?= base64_encode($course['id']) ?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
                        <td><a href="./delete.php?id=<?= base64_encode($course['id']) ?>"><i class="fa-solid fa-trash"></i></i></a></td>
